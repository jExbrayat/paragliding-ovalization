...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updatePlot(wind_vx, time_for_one_turn, wing_vz, wing_vx) {
        ...
        let y_values = x_axis.map(thermal_vz => compute_solution(wind_vx = wind_vx, thermal_vz = thermal_vz, time_for_one_turn = time_for_one_turn, wing_vz = wing_vz, wing_vx = wing_vx));
        var plotly_trace = {
            x: x_axis,
            y: y_values,
            mode: 'lines',
    ...
    updatePlot(wind_vx = selectedWindVx, time_for_one_turn = selectedTimeForOneTurn, wing_vz = selectedWingVz, wing_vx = selectedWingVx);
    ...
    sliderObject.addEventListener('input', (event) => {
        ...
        wind_vx = selectedWindVx, time_for_one_turn = selectedTimeForOneTurn, wing_vz = selectedWingVz, wing_vx = selectedWingVx);
    });
